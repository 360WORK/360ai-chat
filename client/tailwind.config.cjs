  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'ai360-accent': 'var(--ai360-accent)',
        'ai360-accent-hover': 'var(--ai360-accent-hover)',
        'ai360-action': 'var(--ai360-action)',
        'ai360-action-bg': 'var(--ai360-action-bg)',
        'ai360-action-border': 'var(--ai360-action-border)',
        'ai360-positive': 'var(--ai360-positive)',
        'ai360-positive-bg': 'var(--ai360-positive-bg)',
        'ai360-alert': 'var(--ai360-alert)',
        'ai360-alert-bg': 'var(--ai360-alert-bg)',
        'ai360-card': 'var(--ai360-card)',
        'ai360-card-border': 'var(--ai360-card-border)',
        'ai360-chip-border': 'var(--ai360-chip-border)',
